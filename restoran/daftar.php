        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              <label class="control-label">Nomor Hp(wa)</label>
              <div class="controls">
                <input name="Telfon" type="text"  class="span11" placeholder="telfon"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">email</label>
              <div class="controls">
                <input name="email" type="Email"  class="span11" placeholder="Email"  />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select class="span11" name="Referal">
                  <option value="1">NONE</option>
                  <option value="2">AGUS</option>
                  <option value="3">BUDI</option>
                  <option value="4">CERRY</option>
                  <option value="5">DODIT</option>
                </select>
              </div>
            </div>
          ...
          <?php
            if(isset($_POST['kirim_daftar'])){
              ...
              //echo "<br></br>";
              $query_daftar = "insert into tb_user values ('','$username','$password','$nama_user','$Referal','$status')";
